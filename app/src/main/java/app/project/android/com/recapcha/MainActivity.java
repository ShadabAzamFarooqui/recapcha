package app.project.android.com.recapcha;
...
import app.project.android.com.recapcha.api.TokenVerificationApi;
import app.project.android.com.recapcha.model.ReCaptchaDetails;
import app.project.android.com.recapcha.util.ReCaptchaVerification;
import app.project.android.com.recapcha.util.Util;
...
//                    .setIcon(R.drawable.ic_user_verify)
    ...
    public void updateReCaptchaStatus(ReCaptchaDetails reCaptchaDetails) {
        if (reCaptchaDetails.isValid()) {
            ...
            Toast.makeText(getApplicationContext(), "" + reCaptchaDetails.getFailDetail().getStatus().getStatusMessage(), Toast.LENGTH_SHORT).show();
